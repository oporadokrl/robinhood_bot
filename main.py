...
try:
	...
	if choice == 's' or choice == 'S':
		os.system('pip3 install pyTelegramBotAPI requests moviepy pytube')
		import requests,pytube,telebot
		from telebot import TeleBot
		import moviepy.editor as mp
	else:
...
def consultacpf(message):
	...
	#os.system("cd data && python3 JLconsultas.py && grep")
	JLconsultas.consultar(message,bot,mode)
